...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    ...
    public  class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnCreateContextMenuListener
        ...
        public ImageViewHolder(View itemView) {
            ...
            textViewName= (TextView) itemView.findViewById(R.id.text_view_ad);
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
            menu.setHeaderTitle("Aktivasyon Seçin");
            MenuItem doWhatever=menu.add(Menu.NONE,1,1,"Ne İstersen Yap");
